...
abstract final class RadixDarkColors {
  ...
  static const RadixColorsSwatch amber = RadixColorsSwatch(
    [
      /* 1  */ RadixColor(0xFF16120C /* #16120C */, Color.fromRGBO(230, 60 , 0  , 0.0235) /* #E63C00 */),
      /* 2  */ RadixColor(0xFF1D180F /* #1D180F */, Color.fromRGBO(253, 155, 0  , 0.051 ) /* #FD9B00 */),
      /* 3  */ RadixColor(0xFF302008 /* #302008 */, Color.fromRGBO(250, 130, 0  , 0.1333) /* #FA8200 */),
      /* 4  */ RadixColor(0xFF3F2700 /* #3F2700 */, Color.fromRGBO(252, 130, 0  , 0.1961) /* #FC8200 */),
      /* 5  */ RadixColor(0xFF4D3000 /* #4D3000 */, Color.fromRGBO(253, 139, 0  , 0.2549) /* #FD8B00 */),
      /* 6  */ RadixColor(0xFF5C3D05 /* #5C3D05 */, Color.fromRGBO(253, 155, 0  , 0.3176) /* #FD9B00 */),
      /* 7  */ RadixColor(0xFF714F19 /* #714F19 */, Color.fromRGBO(255, 171, 37 , 0.4039) /* #FFAB25 */),
      /* 8  */ RadixColor(0xFF8F6424 /* #8F6424 */, Color.fromRGBO(255, 174, 53 , 0.5294) /* #FFAE35 */),
      /* 9  */ RadixColor(0xFFFFC53D /* #FFC53D */, Color.fromRGBO(255, 197, 61 , 1     ) /* #FFC53D */),
      /* 10 */ RadixColor(0xFFFFD60A /* #FFD60A */, Color.fromRGBO(255, 214, 10 , 1     ) /* #FFD60A */),
      /* 11 */ RadixColor(0xFFFFCA16 /* #FFCA16 */, Color.fromRGBO(255, 202, 22 , 1     ) /* #FFCA16 */),
      /* 12 */ RadixColor(0xFFFFE7B3 /* #FFE7B3 */, Color.fromRGBO(255, 231, 179, 1     ) /* #FFE7B3 */),
    ],
