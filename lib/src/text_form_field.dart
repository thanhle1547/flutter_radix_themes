...
/// A [FormField] that contains a [RadixTextField].
///
/// This is a convenience widget that wraps a [RadixTextField] widget in a
/// [FormField].
///
...
/// are discarded.
///
/// By default, `decoration` will apply the [RadixThemeData.inputDecorationTheme] or
/// [RadixThemeExtension.inputDecorationTheme] for the current context
/// to the [RadixInputDecoration], see [RadixInputDecoration.applyDefaults].
///
/// For a documentation about the various parameters, see [RadixTextField].
///
/// {@tool snippet}
///
/// Creates a [RadixTextFormField] with an [RadixInputDecoration] and validator function.
///
/// ![If the user enters valid text, the RadixTextField appears normally without any warnings to the user](https://flutter.github.io/assets-for-api-docs/assets/material/text_form_field.png)
///
...
///
/// ** See code in examples/api/lib/text_form_field/text_form_field.1.dart **
/// {@end-tool}
///
/// {@tool dartpad}
...
///
/// ** See code in examples/api/lib/text_form_field/text_form_field.2.dart **
/// {@end-tool}
///
/// See also:
///
///  * [RadixTextField], which is the underlying text field without the [Form]
///    integration.
///  * [RadixInputDecorator], which shows the labels and other visual elements that
...
class RadixTextFormField extends FormField<String> {
  /// Creates a [FormField] that contains a [RadixTextField].
  ///
  ...
  ///
  /// For documentation about the various parameters, see the [RadixTextField]
  /// class and [RadixTextField.new], the constructor.
  RadixTextFormField({
    super.key,
    ...
    RadixInputDecoration? decoration = const RadixInputDecoration(),
    ...
    List<Locale>? hintLocales,
       ...
       super(
         ...
         builder: (FormFieldState<String> field) {
          ...
          RadixInputDecorationThemeData? defaultDecoration = RadixInputDecorationTheme.of(field.context);
  ...
  @override
  FormFieldState<String> createState() => _RadixTextFormFieldState();
}

class _RadixTextFormFieldState extends FormFieldState<String> {
  RestorableTextEditingController? _controller;

  TextEditingController get _effectiveController => _textFormField.controller ?? _controller!.value;

  RadixTextFormField get _textFormField => super.widget as RadixTextFormField;
  ...
  @override
  void didUpdateWidget(RadixTextFormField oldWidget) {
